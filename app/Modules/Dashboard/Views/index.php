...
<template>
    ...
    <v-row>
        <v-col lg="3" cols="sm" class="pb-2">
            <v-card link href="<?= base_url('penjualan'); ?>" min-height="130px">
                <div class="pa-5">
        ...
        <v-col lg="3" cols="sm" class="pb-2">
            <v-card link href="<?= base_url('barang'); ?>" min-height="130px">
                <div class="pa-5">
        ...
        <v-col lg="3" cols="sm" class="pb-2">
            <v-card link href="<?= base_url('kontak'); ?>" min-height="130px">
                <div class="pa-5">
        ...
        <v-col lg="3" cols="sm" class="pb-2">
            <v-card link href="<?= base_url('user'); ?>" min-height="130px">
                <div class="pa-5">
