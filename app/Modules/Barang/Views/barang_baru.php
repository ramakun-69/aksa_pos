            ...
            <v-form ref="form" v-model="valid">
                ...
                <v-row class="mt-n4">
                    ...
                    <v-col cols="12" sm="9">
                        <v-row>
                            <v-col col="12" sm="7">
                                <v-select v-model="idSatuan" label="<?= lang('App.selectUnit'); ?>" :items="dataSatuan" item-text="nama_satuan" item-value="id_satuan" :error-messages="satuan_barangError" :loading="loading2" outlined dense @change="getSatuanById" append-outer-icon="mdi-plus-thick" @click:append-outer="addSatuan"></v-select>
                            </v-col>
                            <v-col col="12" sm="5">
                ...
                <v-row class="mt-n4">
                    ...
                    <v-col cols="12" md="9">
                        ...
                        <v-text-field label="<?= lang('App.priceSell') ?> *" v-model="hargaJual" type="number" :error-messages="harga_jualError" prefix="Rp" :suffix=" untungPersen.toFixed() + '% untung'" outlined dense></v-text-field>
